...
public class AdRecord {
    ...
    public static void printScanRecord (int[] scanRecord)
    {
        ...
        try {
            ...
            if(Constant.DEBUG)
                Log.i(Constant.TAG, "AdRecord -- printScanRecord -> decoded String : " + ByteArrayToString(scanRecord));
        ...
        {
            if(Constant.DEBUG)
                Log.i(Constant.TAG, "AdRecord -- printScanRecord -> Scan Record Empty");
        } else {

            if(Constant.DEBUG)
                Log.i(Constant.TAG, "AdRecord -- printScanRecord -> Scan Record: " + TextUtils.join(",", records));
        }
